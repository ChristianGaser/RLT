function rlt_set_com_and_scale_mouse(vargin)
...
% pre-estimated COM of mouse template
com_reference = [0 -26 -31];
...
for i=1:n
  ...
  if any(vx_vol<0.5)
    fprintf('Correct voxel size by factor 10.\n');
    iM([1:3 7:9]) = 10*iM([1:3 7:9]);
